...
> Working directory: `/Users/zhaotang/projects/clickstream` (note: outside the Resume
...
- `/Users/zhaotang/projects/clickstream/DESIGN.md` (authoritative design doc: architecture, tech-stack coverage matrix, milestones)
- `/Users/zhaotang/projects/clickstream/README.md`
- `/Users/zhaotang/projects/clickstream/docs/tech-stack-addons.md` (planned v1/v2 additions)
- `/Users/zhaotang/projects/clickstream/docs/sre-reliability-addons.md` (reliability track)
- `/Users/zhaotang/projects/clickstream/docs/collaboration-and-resources.md` (guardrails: no proprietary code, public-repo safe)
- `/Users/zhaotang/projects/Resume/sample_jd/` (saved JDs to keep tech coverage aligned)
...
- No code/config copied from any employer (Intuit) — all code original, generic, public-repo safe.
